...
const { findOrCreateUser, addRefreshTokenToUser } = require('./mockUserStore'); // Add addRefreshTokenToUser
const { generateAuthTokens } = require('./tokenUtils'); // Updated import
...
if (!googleClientId || !googleClientSecret) {
  throw new Error(
    'GOOGLE_CLIENT_ID or GOOGLE_CLIENT_SECRET is not defined. Google OAuth Strategy cannot be set up.'
  );
}
...
/**
 * Configures and registers the Google OAuth2.0 strategy with a Passport instance.
